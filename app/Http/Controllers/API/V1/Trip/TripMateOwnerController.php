...
final class TripMateOwnerController extends ApiController
{
    ...
    public function updadeStatus(Request $request, Trip $trip, TripMate $mate, UpdateTripMateStatusAction $action)
    {
    ...
    protected function mapAbility(TripMateStatusEnum $status): string
    {
        return match ($status) {
